...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.Trasmissione} 
 *
...
public class JDBCTrasmissioneServiceSearch implements ITrasmissioneServiceSearch {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<Trasmissione, IdTrasmissione, JDBCServiceManager> serviceSearch = null;
	public JDBCTrasmissioneServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCTrasmissioneServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("trasmissione");
		this.serviceSearch.setServiceManager(new JDBCLimitedServiceManager(this.jdbcServiceManager));
	}
		
	//@Override
	public Trasmissione get(IdTrasmissione id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	//@Override
	public List<Trasmissione> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	//@Override
	public Trasmissione find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
