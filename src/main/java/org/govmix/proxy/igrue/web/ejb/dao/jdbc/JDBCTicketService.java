...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.Ticket} 
 *
...
public class JDBCTicketService extends JDBCTicketServiceSearch  implements ITicketService {


	private IJDBCServiceCRUDWithId<Ticket, TicketId, JDBCServiceManager> serviceCRUD = null;
	public JDBCTicketService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		super(jdbcServiceManager);
		this.log.debug(JDBCTicketService.class.getName()+ " initialized");
		this.serviceCRUD = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceCRUD("ticket");
	...
	//@Override
	public void create(Ticket ticket) throws ServiceException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(ticket==null){
				throw new Exception("Parameter (type:"+Ticket.class.getName()+") 'ticket' is null");
			}
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,ticket);			
	...
	//@Override
	public void update(TicketId oldId, Ticket ticket) throws ServiceException, NotFoundException, NotImplementedException {
		...
		try{
			...
			if(oldId==null){
				throw new Exception("Parameter (type:"+TicketId.class.getName()+") 'oldId' is null");
			}
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,ticket);
	...
	//@Override
	public void updateOrCreate(TicketId oldId, Ticket ticket) throws ServiceException, NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,ticket);
	...
	//@Override
	public void delete(Ticket ticket) throws ServiceException,NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.delete(this.jdbcProperties,this.log,connection,sqlQueryObject,ticket);	
	...
	//@Override
	public void deleteById(TicketId id) throws ServiceException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+TicketId.class.getName()+") 'id' is null");
			}
