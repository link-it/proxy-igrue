 ...
 *
 */
package org.govmix.proxy.igrue.web.ejb;
...
public class Proxy implements Serializable , Cloneable {
  ...
  public Ticket removeTicket(int index) {
    return this.ticket.remove( index );
  }
  ...
  public void addEsito(Esito esito) {
    this.esito.add(esito);
  }

  public Esito getEsito(int index) {
    return this.esito.get( index );
  }

  public Esito removeEsito(int index) {
    return this.esito.remove( index );
  }
  ...
  public void setEsitoList(List<Esito> esito) {
    this.esito=esito;
  }

  public int sizeEsitoList() {
  ...
  public Evento getEvento(int index) {
    return this.evento.get( index );
  }

  public Evento removeEvento(int index) {
    return this.evento.remove( index );
  }
  ...
  public int sizeEventoList() {
    return this.evento.size();
  }

  public void addProprietaEvento(ProprietaEvento proprietaEvento) {
    this.proprietaEvento.add(proprietaEvento);
  }

  public ProprietaEvento getProprietaEvento(int index) {
    return this.proprietaEvento.get( index );
  }

  public ProprietaEvento removeProprietaEvento(int index) {
    return this.proprietaEvento.remove( index );
  }

  public List<ProprietaEvento> getProprietaEventoList() {
    return this.proprietaEvento;
  }

  public void setProprietaEventoList(List<ProprietaEvento> proprietaEvento) {
    this.proprietaEvento=proprietaEvento;
  }

  public int sizeProprietaEventoList() {
    return this.proprietaEvento.size();
  }

  public void addTipievento(Tipievento tipievento) {
    this.tipievento.add(tipievento);
  }

  public Tipievento getTipievento(int index) {
    return this.tipievento.get( index );
  }

  public Tipievento removeTipievento(int index) {
    return this.tipievento.remove( index );
  }

  public List<Tipievento> getTipieventoList() {
    return this.tipievento;
  }

  public void setTipieventoList(List<Tipievento> tipievento) {
    this.tipievento=tipievento;
  }

  public int sizeTipieventoList() {
    return this.tipievento.size();
  }

  public void addTabellacontesto(Tabellacontesto tabellacontesto) {
    this.tabellacontesto.add(tabellacontesto);
  }

  public Tabellacontesto getTabellacontesto(int index) {
    return this.tabellacontesto.get( index );
  }

  public Tabellacontesto removeTabellacontesto(int index) {
    return this.tabellacontesto.remove( index );
  }

  public List<Tabellacontesto> getTabellacontestoList() {
    return this.tabellacontesto;
  }

  public void setTabellacontestoList(List<Tabellacontesto> tabellacontesto) {
    this.tabellacontesto=tabellacontesto;
  }

  public int sizeTabellacontestoList() {
    return this.tabellacontesto.size();
  }

  public void addMailTemplate(MailTemplate mailTemplate) {
    this.mailTemplate.add(mailTemplate);
  }

  public MailTemplate getMailTemplate(int index) {
    return this.mailTemplate.get( index );
  }

  public MailTemplate removeMailTemplate(int index) {
    return this.mailTemplate.remove( index );
  }
  ...
  public void setMailTemplateList(List<MailTemplate> mailTemplate) {
    this.mailTemplate=mailTemplate;
  }

  public int sizeMailTemplateList() {
    return this.mailTemplate.size();
  }

  public void addMailTrace(MailTrace mailTrace) {
    this.mailTrace.add(mailTrace);
  }

  public MailTrace getMailTrace(int index) {
    return this.mailTrace.get( index );
  }

  public MailTrace removeMailTrace(int index) {
    return this.mailTrace.remove( index );
  }

  public List<MailTrace> getMailTraceList() {
    return this.mailTrace;
  }

  public void setMailTraceList(List<MailTrace> mailTrace) {
    this.mailTrace=mailTrace;
  }

  public int sizeMailTraceList() {
    return this.mailTrace.size();
  }
  ...
  */
  ...
  protected List<Ticket> ticket = new ArrayList<Ticket>();

  /**
   * @deprecated Use method getTicketList
   * @return List<Ticket>
  */
  @Deprecated
  ...
  /**
   * @deprecated Use method setTicketList
   * @param ticket List<Ticket>
  */
  @Deprecated
  ...
  /**
   * @deprecated Use method sizeTicketList
   * @return lunghezza della lista
  */
  @Deprecated
  ...
  protected List<Esito> esito = new ArrayList<Esito>();

  /**
   * @deprecated Use method getEsitoList
   * @return List<Esito>
  */
  @Deprecated
  ...
  /**
   * @deprecated Use method setEsitoList
   * @param esito List<Esito>
  */
  @Deprecated
  ...
  /**
   * @deprecated Use method sizeEsitoList
   * @return lunghezza della lista
  */
  @Deprecated
  public int sizeEsito() {
  	return this.esito.size();
  }

  protected List<Evento> evento = new ArrayList<Evento>();

  /**
   * @deprecated Use method getEventoList
   * @return List<Evento>
  */
  @Deprecated
  ...
  /**
   * @deprecated Use method setEventoList
   * @param evento List<Evento>
  */
  @Deprecated
  ...
  /**
   * @deprecated Use method sizeEventoList
   * @return lunghezza della lista
  */
  @Deprecated
  public int sizeEvento() {
  	return this.evento.size();
  }

  protected List<ProprietaEvento> proprietaEvento = new ArrayList<ProprietaEvento>();

  /**
   * @deprecated Use method getProprietaEventoList
   * @return List<ProprietaEvento>
  */
  @Deprecated
  public List<ProprietaEvento> getProprietaEvento() {
  	return this.proprietaEvento;
  }

  /**
   * @deprecated Use method setProprietaEventoList
   * @param proprietaEvento List<ProprietaEvento>
  */
  @Deprecated
  public void setProprietaEvento(List<ProprietaEvento> proprietaEvento) {
  	this.proprietaEvento=proprietaEvento;
  }

  /**
   * @deprecated Use method sizeProprietaEventoList
   * @return lunghezza della lista
  */
  @Deprecated
  public int sizeProprietaEvento() {
  	return this.proprietaEvento.size();
  }

  protected List<Tipievento> tipievento = new ArrayList<Tipievento>();

  /**
   * @deprecated Use method getTipieventoList
   * @return List<Tipievento>
  */
  @Deprecated
  public List<Tipievento> getTipievento() {
  	return this.tipievento;
  }

  /**
   * @deprecated Use method setTipieventoList
   * @param tipievento List<Tipievento>
  */
  @Deprecated
  public void setTipievento(List<Tipievento> tipievento) {
  	this.tipievento=tipievento;
  }

  /**
   * @deprecated Use method sizeTipieventoList
   * @return lunghezza della lista
  */
  @Deprecated
  public int sizeTipievento() {
  	return this.tipievento.size();
  }

  protected List<Tabellacontesto> tabellacontesto = new ArrayList<Tabellacontesto>();

  /**
   * @deprecated Use method getTabellacontestoList
   * @return List<Tabellacontesto>
  */
  @Deprecated
  public List<Tabellacontesto> getTabellacontesto() {
  	return this.tabellacontesto;
  }

  /**
   * @deprecated Use method setTabellacontestoList
   * @param tabellacontesto List<Tabellacontesto>
  */
  @Deprecated
  public void setTabellacontesto(List<Tabellacontesto> tabellacontesto) {
  	this.tabellacontesto=tabellacontesto;
  }

  /**
   * @deprecated Use method sizeTabellacontestoList
   * @return lunghezza della lista
  */
  @Deprecated
  public int sizeTabellacontesto() {
  	return this.tabellacontesto.size();
  }

  protected List<MailTemplate> mailTemplate = new ArrayList<MailTemplate>();

  /**
   * @deprecated Use method getMailTemplateList
  ...
  */
  ...
  /**
   * @deprecated Use method setMailTemplateList
   * @param mailTemplate List<MailTemplate>
  */
  @Deprecated
  ...
  /**
   * @deprecated Use method sizeMailTemplateList
   * @return lunghezza della lista
  */
  @Deprecated
  public int sizeMailTemplate() {
  	return this.mailTemplate.size();
  }

  protected List<MailTrace> mailTrace = new ArrayList<MailTrace>();

  /**
   * @deprecated Use method getMailTraceList
   * @return List<MailTrace>
  */
  @Deprecated
  public List<MailTrace> getMailTrace() {
  	return this.mailTrace;
  }

  /**
   * @deprecated Use method setMailTraceList
   * @param mailTrace List<MailTrace>
  */
  @Deprecated
  public void setMailTrace(List<MailTrace> mailTrace) {
  	this.mailTrace=mailTrace;
  }

  /**
   * @deprecated Use method sizeMailTraceList
   * @return lunghezza della lista
  */
  @Deprecated
  public int sizeMailTrace() {
  	return this.mailTrace.size();
  }
