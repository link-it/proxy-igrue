...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.Tipievento} 
 *
...
public class JDBCTipieventoService extends JDBCTipieventoServiceSearch  implements ITipieventoService {


	private IJDBCServiceCRUDWithoutId<Tipievento, JDBCServiceManager> serviceCRUD = null;
	public JDBCTipieventoService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		super(jdbcServiceManager);
		this.log.debug(JDBCTipieventoService.class.getName()+ " initialized");
		this.serviceCRUD = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceCRUD("tipievento");
	...
	//@Override
	public void create(Tipievento tipievento) throws ServiceException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(tipievento==null){
				throw new Exception("Parameter (type:"+Tipievento.class.getName()+") 'tipievento' is null");
			}
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,tipievento);			
	...
	//@Override
	public void update(Tipievento tipievento) throws ServiceException, NotFoundException, NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,tipievento);
	...
	//@Override
	public void updateOrCreate(Tipievento tipievento) throws ServiceException, NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,tipievento);
	...
	//@Override
	public void delete(Tipievento tipievento) throws ServiceException,NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.delete(this.jdbcProperties,this.log,connection,sqlQueryObject,tipievento);	
