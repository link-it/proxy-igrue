...
public class Ticket implements Serializable , Cloneable {
  ...
  public java.util.Date getDataassegnazione() {
    return this.dataassegnazione;
  }

  public void setDataassegnazione(java.util.Date dataassegnazione) {
    this.dataassegnazione = dataassegnazione;
  }

  public java.util.Date getDatafinetrasmissione() {
    return this.datafinetrasmissione;
  }

  public void setDatafinetrasmissione(java.util.Date datafinetrasmissione) {
    this.datafinetrasmissione = datafinetrasmissione;
  }

  public boolean getFilericevuto() {
    return this.filericevuto;
  }

  public void setFilericevuto(boolean filericevuto) {
    this.filericevuto = filericevuto;
  }
  ...
  public static org.govmix.proxy.igrue.web.ejb.model.TicketModel model(){
	  return new org.govmix.proxy.igrue.web.ejb.model.TicketModel();
  }
  ...
  protected java.util.Date dataassegnazione;

  protected java.util.Date datafinetrasmissione;

  protected boolean filericevuto;

  protected java.lang.String idticket;
