...
/** 
* Service can be used for research objects on the backend of type org.govmix.proxy.igrue.web.ejb.Ticket  
 *
...
public interface ITicketServiceSearch extends IServiceSearchWithId<Ticket, TicketId> {
}
