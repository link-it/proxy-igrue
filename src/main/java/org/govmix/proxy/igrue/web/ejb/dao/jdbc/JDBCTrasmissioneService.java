...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.Trasmissione} 
 *
...
public class JDBCTrasmissioneService extends JDBCTrasmissioneServiceSearch  implements ITrasmissioneService {


	private IJDBCServiceCRUDWithId<Trasmissione, IdTrasmissione, JDBCServiceManager> serviceCRUD = null;
	public JDBCTrasmissioneService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		super(jdbcServiceManager);
		this.log.debug(JDBCTrasmissioneService.class.getName()+ " initialized");
		this.serviceCRUD = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceCRUD("trasmissione");
	...
	//@Override
	public void create(Trasmissione trasmissione) throws ServiceException, NotImplementedException {
		...
		try{
			...
			if(trasmissione==null){
				throw new Exception("Parameter (type:"+Trasmissione.class.getName()+") 'trasmissione' is null");
			}
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,trasmissione);			
	...
	//@Override
	public void update(IdTrasmissione oldId, Trasmissione trasmissione) throws ServiceException, NotFoundException, NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,trasmissione);
	...
	//@Override
	public void updateOrCreate(IdTrasmissione oldId, Trasmissione trasmissione) throws ServiceException, NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,trasmissione);
	...
	//@Override
	public void delete(Trasmissione trasmissione) throws ServiceException,NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.delete(this.jdbcProperties,this.log,connection,sqlQueryObject,trasmissione);	
