...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.MailTrace} 
 *
...
public class JDBCMailTraceServiceSearch implements IMailTraceServiceSearch {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<MailTrace, MailTraceId, JDBCServiceManager> serviceSearch = null;
	public JDBCMailTraceServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCMailTraceServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("mailTrace");
		this.serviceSearch.setServiceManager(new JDBCLimitedServiceManager(this.jdbcServiceManager));
	}
		
	//@Override
	public MailTrace get(MailTraceId id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	//@Override
	public boolean exists(MailTraceId id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	//@Override
	public List<MailTraceId> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	//@Override
	public List<MailTrace> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	//@Override
	public MailTrace find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	//@Override
	public InUse inUse(MailTraceId id) throws ServiceException, NotFoundException,NotImplementedException {
