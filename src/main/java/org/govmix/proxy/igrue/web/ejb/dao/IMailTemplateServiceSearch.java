...
/** 
* Service can be used for research objects on the backend of type org.govmix.proxy.igrue.web.ejb.MailTemplate  
 *
...
public interface IMailTemplateServiceSearch extends IServiceSearchWithId<MailTemplate, MailTemplateId> {
}
