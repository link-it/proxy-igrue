...
public class ProprietaEvento implements Serializable , Cloneable {
  private Long id;


  public ProprietaEvento() {
  }
  ...
  public static org.govmix.proxy.igrue.web.ejb.model.ProprietaEventoModel model(){
	  return new org.govmix.proxy.igrue.web.ejb.model.ProprietaEventoModel();
  }
