...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.Tipievento} 
 *
...
public class JDBCTipieventoServiceSearch implements ITipieventoServiceSearch {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithoutId<Tipievento, JDBCServiceManager> serviceSearch = null;
	public JDBCTipieventoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCTipieventoServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("tipievento");
	...
	//@Override
	public List<Tipievento> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	//@Override
	public Tipievento find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
