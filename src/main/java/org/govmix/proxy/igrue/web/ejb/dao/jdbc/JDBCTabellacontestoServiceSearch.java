...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.Tabellacontesto} 
 *
...
public class JDBCTabellacontestoServiceSearch implements ITabellacontestoServiceSearch {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<Tabellacontesto, IdTabellacontesto, JDBCServiceManager> serviceSearch = null;
	public JDBCTabellacontestoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCTabellacontestoServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("tabellacontesto");
		this.serviceSearch.setServiceManager(new JDBCLimitedServiceManager(this.jdbcServiceManager));
	}
		
	//@Override
	public Tabellacontesto get(IdTabellacontesto id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	//@Override
	public boolean exists(IdTabellacontesto id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	//@Override
	public List<IdTabellacontesto> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	//@Override
	public List<Tabellacontesto> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	//@Override
	public Tabellacontesto find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	//@Override
	public InUse inUse(IdTabellacontesto id) throws ServiceException, NotFoundException,NotImplementedException {
