...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.Ticket} 
 *
...
public class JDBCTicketServiceSearch implements ITicketServiceSearch {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<Ticket, TicketId, JDBCServiceManager> serviceSearch = null;
	public JDBCTicketServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCTicketServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("ticket");
		this.serviceSearch.setServiceManager(new JDBCLimitedServiceManager(this.jdbcServiceManager));
	}
		
	//@Override
	public Ticket get(TicketId id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	//@Override
	public boolean exists(TicketId id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	//@Override
	public List<TicketId> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	//@Override
	public List<Ticket> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	//@Override
	public Ticket find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	//@Override
	public InUse inUse(TicketId id) throws ServiceException, NotFoundException,NotImplementedException {
