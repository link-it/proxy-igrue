...
public class Tipievento implements Serializable , Cloneable {
  private Long id;
  ...
  public static org.govmix.proxy.igrue.web.ejb.model.TipieventoModel model(){
	  return new org.govmix.proxy.igrue.web.ejb.model.TipieventoModel();
  }
