...
public class IdTrasmissione implements Serializable , Cloneable {
	private Long id;
	...
	public String toString(){
		...
		//compongo la chiave:
		// 
		if(this.utente != null && this.utente.getIdAmministrazione() != null && this.utente.getIdSistema() != null && this.file != null){
			bf.append(this.utente.getIdAmministrazione());
			bf.append("_");
			bf.append(this.utente.getIdSistema());
			bf.append("_");
			bf.append(this.file);
