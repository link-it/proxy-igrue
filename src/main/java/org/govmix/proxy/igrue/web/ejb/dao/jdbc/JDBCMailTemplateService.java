...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.MailTemplate} 
 *
...
public class JDBCMailTemplateService extends JDBCMailTemplateServiceSearch  implements IMailTemplateService {


	private IJDBCServiceCRUDWithId<MailTemplate, MailTemplateId, JDBCServiceManager> serviceCRUD = null;
	...
	public void create(MailTemplate mailTemplate) throws ServiceException, NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,mailTemplate);			
	...
	//@Override
	public void update(MailTemplateId oldId, MailTemplate mailTemplate) throws ServiceException, NotFoundException, NotImplementedException {
		...
		try{
			...
			if(oldId==null){
				throw new Exception("Parameter (type:"+MailTemplateId.class.getName()+") 'oldId' is null");
			}
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,mailTemplate);
	...
	//@Override
	public void updateOrCreate(MailTemplateId oldId, MailTemplate mailTemplate) throws ServiceException, NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,mailTemplate);
	...
	//@Override
	public void deleteById(MailTemplateId id) throws ServiceException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+MailTemplateId.class.getName()+") 'id' is null");
			}
