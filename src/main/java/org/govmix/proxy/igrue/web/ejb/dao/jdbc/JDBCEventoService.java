...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.Evento} 
 *
...
public class JDBCEventoService extends JDBCEventoServiceSearch  implements IEventoService {
	...
	public void create(Evento evento) throws ServiceException, NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,evento);			
	...
	public void update(Evento evento) throws ServiceException, NotFoundException, NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,evento);
	...
	public void updateOrCreate(Evento evento) throws ServiceException, NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,evento);
