...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.MailTemplate} 
 *
...
public class JDBCMailTemplateServiceSearch implements IMailTemplateServiceSearch {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<MailTemplate, MailTemplateId, JDBCServiceManager> serviceSearch = null;
	...
	//@Override
	public MailTemplate get(MailTemplateId id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	//@Override
	public boolean exists(MailTemplateId id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	//@Override
	public List<MailTemplateId> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	//@Override
	public InUse inUse(MailTemplateId id) throws ServiceException, NotFoundException,NotImplementedException {
