...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.Tabellacontesto} 
 *
...
public class JDBCTabellacontestoService extends JDBCTabellacontestoServiceSearch  implements ITabellacontestoService {


	private IJDBCServiceCRUDWithId<Tabellacontesto, IdTabellacontesto, JDBCServiceManager> serviceCRUD = null;
	public JDBCTabellacontestoService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		super(jdbcServiceManager);
		this.log.debug(JDBCTabellacontestoService.class.getName()+ " initialized");
		this.serviceCRUD = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceCRUD("tabellacontesto");
	...
	//@Override
	public void create(Tabellacontesto tabellacontesto) throws ServiceException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(tabellacontesto==null){
				throw new Exception("Parameter (type:"+Tabellacontesto.class.getName()+") 'tabellacontesto' is null");
			}
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,tabellacontesto);			
	...
	//@Override
	public void update(IdTabellacontesto oldId, Tabellacontesto tabellacontesto) throws ServiceException, NotFoundException, NotImplementedException {
		...
		try{
			...
			if(oldId==null){
				throw new Exception("Parameter (type:"+IdTabellacontesto.class.getName()+") 'oldId' is null");
			}
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,tabellacontesto);
	...
	//@Override
	public void updateOrCreate(IdTabellacontesto oldId, Tabellacontesto tabellacontesto) throws ServiceException, NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,tabellacontesto);
	...
	//@Override
	public void delete(Tabellacontesto tabellacontesto) throws ServiceException,NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.delete(this.jdbcProperties,this.log,connection,sqlQueryObject,tabellacontesto);	
	...
	//@Override
	public void deleteById(IdTabellacontesto id) throws ServiceException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdTabellacontesto.class.getName()+") 'id' is null");
			}
