...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.ProprietaEvento} 
 *
...
public class JDBCProprietaEventoServiceSearch implements IProprietaEventoServiceSearch {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<ProprietaEvento, ProprietaEventiId, JDBCServiceManager> serviceSearch = null;
	public JDBCProprietaEventoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCProprietaEventoServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("proprietaEvento");
		this.serviceSearch.setServiceManager(new JDBCLimitedServiceManager(this.jdbcServiceManager));
	}
		
	//@Override
	public ProprietaEvento get(ProprietaEventiId id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	//@Override
	public boolean exists(ProprietaEventiId id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	//@Override
	public List<ProprietaEventiId> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	//@Override
	public List<ProprietaEvento> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	//@Override
	public ProprietaEvento find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	//@Override
	public InUse inUse(ProprietaEventiId id) throws ServiceException, NotFoundException,NotImplementedException {
