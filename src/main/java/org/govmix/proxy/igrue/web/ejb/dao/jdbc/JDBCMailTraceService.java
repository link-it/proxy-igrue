...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.igrue.web.ejb.MailTrace} 
 *
...
public class JDBCMailTraceService extends JDBCMailTraceServiceSearch  implements IMailTraceService {


	private IJDBCServiceCRUDWithId<MailTrace, MailTraceId, JDBCServiceManager> serviceCRUD = null;
	public JDBCMailTraceService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		super(jdbcServiceManager);
		this.log.debug(JDBCMailTraceService.class.getName()+ " initialized");
		this.serviceCRUD = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceCRUD("mailTrace");
	...
	//@Override
	public void create(MailTrace mailTrace) throws ServiceException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(mailTrace==null){
				throw new Exception("Parameter (type:"+MailTrace.class.getName()+") 'mailTrace' is null");
			}
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,mailTrace);			
	...
	//@Override
	public void update(MailTraceId oldId, MailTrace mailTrace) throws ServiceException, NotFoundException, NotImplementedException {
		...
		try{
			...
			if(oldId==null){
				throw new Exception("Parameter (type:"+MailTraceId.class.getName()+") 'oldId' is null");
			}
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,mailTrace);
	...
	//@Override
	public void updateOrCreate(MailTraceId oldId, MailTrace mailTrace) throws ServiceException, NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,mailTrace);
	...
	//@Override
	public void delete(MailTrace mailTrace) throws ServiceException,NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.delete(this.jdbcProperties,this.log,connection,sqlQueryObject,mailTrace);	
	...
	//@Override
	public void deleteById(MailTraceId id) throws ServiceException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+MailTraceId.class.getName()+") 'id' is null");
			}
