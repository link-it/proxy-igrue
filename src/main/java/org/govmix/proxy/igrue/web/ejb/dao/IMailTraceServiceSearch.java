...
/** 
* Service can be used for research objects on the backend of type org.govmix.proxy.igrue.web.ejb.MailTrace  
 *
...
public interface IMailTraceServiceSearch extends IServiceSearchWithId<MailTrace, MailTraceId> {
}
