...
public class MailTraceId implements Serializable , Cloneable {
  private Long id;
  ...
  public MailTemplateId getTemplateId() {
    return this.templateId;
  }

  public void setTemplateId(MailTemplateId templateId) {
  ...
  protected MailTemplateId templateId;
